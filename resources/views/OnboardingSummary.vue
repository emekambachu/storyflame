					...
					<div class="flex flex-col gap-8">
						<div class="flex flex-col items-center gap-3">
							...
							<div class="flex flex-col items-center text-center gap-2">
								...
								>
									{{ summary.genre_focus[0] }}
									<point-icon />
									{{ summary.genre_focus[1] }}
								</p>
							</div>
						</div>
						...
						<template v-if="activeTab == 0">
							...
							<div class="flex flex-col gap-3 text-left items-start w-full">
								...
								<div class="flex gap-8 items-start max-w-full overflow-auto">
									<AchievementCard
										v-for="(achievement, achievementID) in summary.achievements"
										:key="achievementID"
										:item="achievement"
									/>
								</div>
...
onMounted(() => {
	loading.value = true
	axios
		.get<SuccessResponse<any>>('/api/v1/summary')
		.then((response) => {
